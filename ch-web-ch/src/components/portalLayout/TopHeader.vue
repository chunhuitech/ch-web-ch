...
.pic-gif {
	...
	height: 66px;
	margin-left: 10px;
	background: url('../../assets/portal_images/win.gif') no-repeat;
	background-size: 100% 100%;
}
...
.header-search .search-btn .icon-search {
    ...
    margin-top: 15px;
    margin-left: 15px;
    background: url('../../assets/portal_images/icon-search.png') center center no-repeat;
    background-size: 100% 100%;
}
...
.header-search .search-btn :hover .icon-search{
    background: url('../../assets/portal_images/icon-search-white.png') center center no-repeat;
    background-size: 100% 100%;
} */
